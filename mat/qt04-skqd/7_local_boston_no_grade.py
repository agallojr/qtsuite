...
print("RESULTS:")
print("="*60)
print(f"Energy history (per iteration): {result}")
print(f"Final energy: {result[-1]:.6f}")
print(f"Number of iterations completed: {len(result)}")
print("="*60)

# Save result to file
np.savez('result_boston.npz', energy_history=result)
print("\nSaved result to result_boston.npz")
