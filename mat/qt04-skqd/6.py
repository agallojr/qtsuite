...
def construct_krylov_siam(
    ...
    for k in range(krylov_dim):
        ...
        for _ in range(k):
            for instruction in skqd_helpers.trotter_step(qreg, dt, hamiltonian_unitary,
...
if __name__ == "__main__":
    ...
    # Calculate dt based on spectral norm (same formula as helper function)
    ...
    # Transpile circuits using pass manager
    pass_manager = generate_preset_pass_manager(optimization_level=1, backend=backend)
    optimized_circuits = pass_manager.run(krylov_circuits)
