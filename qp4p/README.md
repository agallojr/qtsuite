# Quantum Programming for Programmers (QP4P)

**1Q26** | Instructor: A. Gallo

## ▸ Course Modules

- **[Module 0: Introduction to Quantum Computing for Programmers](mod0/README.md)**
- **[Module 1: Quantum Programming Fundamentals, in the NISQ Era](mod1/README.md)**
- **[Module 2: Searching & Solving, w. CFD Use Cases](mod2/README.md)**
...
There is pre-work and substantive homework, some of a potentially novel nature. It is the intention to direct these efforts to dovetail with our existing research program. By the end of the course student should be able to:

- Explain the basics of quantum computing to peers, and the value proposition (if any).
